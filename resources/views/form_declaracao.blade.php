        ...
        <div class="container align-right" style="bottom:40px">
            <div class="row">
                <div class="mbr-white col-lg-8 col-md-7 content-container">
                    ...
                    <strong>
                        <p class="mbr-text pb-3 mbr-fonts-style display-5"></span> O Microempreendedor
                            Individual deve declarar o valor do faturamento bruto* do <span
                                style="text-transform: uppercase;"><u style="color: #ff8c00">ano anterior </u></span>
                ...
                <div class="col-lg-4 col-md-5">
                    <div class="form-container-declaracao">
                        <div class="media-container-column" data-form-type="formoid">
                            <form method="POST" action="/declaracao"  >
                                <input type="hidden" name="ano_atividade" value="{{$ano_atividade}}">
                                @csrf
                                <input type="hidden" name="declaracao" value="{{$id}}">
                                <input type="hidden" name="cppj" value="{{$cnpj}}">
                                <p class="text-form-valor-title">Escolha o
                                    ano:</p>
                                @if($ano_atividade <=2015|| $ano_atividade ==null)
                                <div data-for="2015" class="col-md-12 form-group ">
                                    <input type="checkbox" name="2015" placeholder="2015" value="S"
                                        data-form-field="2015" id="2015" class="option-input checkbox"> <label
                                        class="mbr-text"><span class="text-form-valor"> Declarar 2015 </span></label>
                                </div>
                                @endif
                                @if($ano_atividade <=2016 || $ano_atividade ==null)
                                <div data-for="2016" class="col-md-12 form-group ">
                                    <input type="checkbox" name="2016" placeholder="2016" value="S"
                                        data-form-field="2016" id="2016" class="option-input checkbox"> <label
                                        class="mbr-text"><span class="text-form-valor"> Declarar 2016 </span></label>
                                </div>
                                @endif
                                @if($ano_atividade <=2017|| $ano_atividade ==null)
                                <div data-for="2017" class="col-md-12 form-group ">
                                    <input type="checkbox" name="2017" placeholder="2017" value="S"
                                        data-form-field="2017" id="2017" class="option-input checkbox"> <label
                                        class="mbr-text"><span class="text-form-valor"> Declarar 2017</span></label>
                                </div>
                                @endif
                                @if($ano_atividade <=2018 || $ano_atividade ==null)
                                <div data-for="2018" class="col-md-12 form-group ">
                                    <input type="checkbox" name="2018" placeholder="2018" value="S"
                                        data-form-field="2018" id="2018" class="option-input checkbox"> <label
                                        class="mbr-text"><span class="text-form-valor"> Declarar 2018  </span></label>
                                </div>
                                @endif
                                @if($ano_atividade <=2019|| $ano_atividade ==null)
                                <div data-for="2019" class="col-md-12 form-group ">
                                    <input type="checkbox" name="2019" placeholder="2019" value="S"
                                        data-form-field="2019" id="2019" class="option-input checkbox"> <label
                                        class="mbr-text"><span class="text-form-valor"> Declarar 2019 </span></label>
                                </div>
                                @endif
                                <div class="col-md-12 input-group-btn" style="text-align: center; padding-top:10px">
