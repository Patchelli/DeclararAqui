...
<body>
    ...
    <section class="header15 cid-rWW8LdyHv5 mbr-fullscreen mbr-parallax-background cid-rWZsu2uGSQ ">

        <div class="container" style="margin-top: -26%;">
            <div class="media-container-row" style="margin-left: 10px;">
                <div class="card p-3 col-12 col-md-8 col-lg-10">
                    <div class="card-wrapper" style="border-radius: 10px;">
                        <h2 style="color: #3CB371;margin-left: 29px;margin-top: 23px;">Pagamento Confirmado</h2>
                        <div class="card-box">
                            <p class="mbr-text mbr-fonts-style display-7" style="font-size: 16px;">
                                Obrigado.
                            </p>
                            <p class="mbr-text mbr-fonts-style display-7">
                                Seu pagamento foi confirmado, em até 3 dias entraremos em contato com você e enviaremos sua declaração anual do MEI.<br> Agradecemos sua confiança na equipe Declare Aqui.
                            </p>
                            <br>
                            <a href="index.php"><button class="btn btn-primary">Página Inicial</button></a>
                        </div>
